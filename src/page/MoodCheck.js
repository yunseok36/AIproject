...
import music from "../image/music_mood.png";
import movie from "../image/movie_mood.png";
import emotion from "../image/emotion_mood.png";
...
function MoodCheck() {
    ...
    return (
        <div className="Page-Design-MoodCheck">
            <div className="MoodCheck-titles">
                <div className="title-MoodCheck">
                    Choose your activity
                </div>
                <div className="subtitle-MoodCheck">
                    원하는 활동을 선택해주세요
                </div>  
            </div>
